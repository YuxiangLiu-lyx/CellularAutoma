"""
Comprehensive Maze 2-Channel CNN Training.

Train 2-channel CNN on Maze rule (different survival range from GoL).
...
def main():
    ...
    output_dir = project_root / "experiments" / "maze_comprehensive"
    ...
    print("="*70)
    print("COMPREHENSIVE MAZE 2-CHANNEL CNN TRAINING")
    print("="*70)
    ...
    final_summary = {
        'experiment': 'Comprehensive Maze 2-Channel CNN Training',
        'rule': {
            'name': 'Maze',
            'survival': '1-5 neighbors',
            'birth': '3 neighbors (same as GoL)'
        },
