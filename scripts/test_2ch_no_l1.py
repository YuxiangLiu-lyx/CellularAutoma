...
Train 10 runs to test convergence.
"""
import sys
...
def main():
    ...
    print(f"  - L1 regularization: NONE (lambda=0)")
    ...
    print(f"Early stopped (no hope): {early_stopped}/10 runs")
    ...
    print("CONCLUSION")
    print("="*70)
    print(f"WITHOUT L1: {converged_count}/10 converged ({converged_count/10*100:.1f}%)")
    print(f"Compare with L1 results to see if L1 regularization helps!")
    print("="*70)
